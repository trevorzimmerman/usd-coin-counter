...
For viewing a demonstration of the coin detection script, including multiple runs and the Roboflow model QR code, please see the project page: [USD Coin Counter](https://trevorzimmerman.github.io/university/machine-vision)
